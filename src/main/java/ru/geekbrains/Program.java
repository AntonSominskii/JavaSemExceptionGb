...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        // Для решения задачи создал два метода divideArrays и subtractArrays
        ...
        try {
            ...
            System.out.println("Частное элементов массивов:" + Arrays.toString(quotient));
        } catch (RuntimeException e) {
            System.err.println("Произошла ошибка: " + e.getMessage());
        }

        int[] subtract = subtractArrays(arr1, arr2);
        System.out.println("Разность элементов массивов:" + Arrays.toString(subtract));
    }
